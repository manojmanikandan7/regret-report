...
Thus, Suite~06 exposes a boundary of the cumulative-regret diagnostic:
...
problems. !TODO: Cite convergence probability and/or simple-regret curves
showing non-convergence for all algorithms and all three problems.!
...
cumulative-regret curves remain close in shape, matching the behavior
already observed in the Suite~06 matched comparison. !TODO:Reference
Suite~06 and the Suite~10 incumbent cumulative-regret figure.! At this
...
visibly separate barrier signature.

The \textsc{Trap}-$5$ median incumbent instantaneous-regret trajectories
...
approximately $k$. !TODO:Reference median incumbent instantaneous-regret
figures for \textsc{Trap}-$5$.! This extended intermediate phase is
...
global optimum. !TODO:Insert table reporting convergence to the local
optimum/deceptive basin by algorithm and problem.!
...
!TODO:Reference Suite 07 incumbent instantaneous regret and history-best plots.!
...
convergence threshold.!TODO:Reference Suite 07 incumbent
...
under a fixed evaluation budget.!TODO:Reference Suite 07 incumbent
instantaneous regret and history-best plots.!
!TODO: Reference Suite 07 incumbent cumulative-regret!
...
signature.}
Suite~11 demonstrates that the instantaneous-regret curve gives a direct
...
\citet{pinto2018practice}, expressed here in the cumulative-regret plane
rather than as a literal crossover fitness level.

Suite~08 validates the theoretical interpretation behind these empirical
readings: on integer-valued benchmarks, the profile-derived and directly
averaged cumulative-regret curves agree within the stated relative
maximum pointwise error threshold (\acrshort{rmae} $<1\%$), supporting
the tail-sum decomposition of Theorem~\ref{thm:regret-profile}. For
real-valued landscapes such as NK, the profile surfaces should still be
read as discretized approximations, a limitation that bounds but does
not invalidate the qualitative conclusions drawn in
Section~\ref{sec:results:nk}. The practical conclusion is that
