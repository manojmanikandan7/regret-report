...
\ref{fig:baseline-cr-leadingones}, and~\ref{fig:baseline-cr-twomax}). In finite-budget experiments the
...
trajectory (Figure~\ref{fig:baseline-cr-binval}). This distinguishes it from time-to-first-optimum
...
\begin{figure}[H]
  ...
  \end{subfigure}
  \caption{Suite~01 incumbent cumulative-regret trajectories for the
...
curves (Figures~\ref{fig:baseline-cr-onemax} and~\ref{fig:baseline-cr-twomax}). However, on
\textsc{LeadingOnes} and \textsc{BinVal}, a structural inversion
emerges (Figures~\ref{fig:baseline-cr-leadingones} and~\ref{fig:baseline-cr-binval}): the algorithms reach the
...
\begin{figure}[H]
  ...
  \end{subfigure}
  \caption{Suite~02 easy-tier summary plots. Convergence probabilities and
...
\begin{figure}[H]
  ...
  \end{subfigure}
  \caption{Selected Suite~02 cumulative-regret trajectories for harder
...
On \acrshort{hiff}-64 no method reaches the optimum within budget; the
best final incumbents reach approximately [X]/$f^\ast$, [Y]/$f^\ast$,
[Z]/$f^\ast$,
and [W]/$f^\ast$.
...
\begin{figure}[H]
  ...
  \end{subfigure}
  \caption{Suite~04 incumbent cumulative-regret trajectories on
...
\begin{figure}[H]
  ...
  \end{subfigure}
  \caption{Suite~04 regret distributions at budget $10{,}000$ for
...
\begin{figure}[H]
  ...
  \begin{subfigure}[t]{0.8\textwidth}
    ...
    \caption{\textsc{Jump}-$3$.}
  \end{subfigure}
  \caption{Suite~05 incumbent instantaneous-regret trajectories for small
...
\begin{figure}[H]
  ...
  \end{subfigure}
  \caption{Suite~05 incumbent instantaneous-regret trajectories for
...
\begin{figure}[H]
  ...
  \end{subfigure}
  \caption{Suite~05 incumbent cumulative-regret trajectories on
...
\begin{figure}[H]
  ...
  \end{subfigure}
  \caption{Suite~09 matched-budget reference for \textsc{Jump}-$2$.
...
but not the accumulated cost of reaching it. !TODO: Quantify the gap at
[budget(s)] using [ratio/difference/test result].!
...
\begin{figure}[H]
  ...
  \end{subfigure}
  \caption{Matched $k=2$ comparison between the neutral-walk
...
\begin{figure}[H]
  ...
  \caption{Budget-$10{,}000$ comparison of \textsc{Plateau}-$5$ and
...
matched-budget Jump reference in Suite~09, since Suite~06 does not contain Jump curves.
...
in the cumulative-regret trajectory (Figure~\ref{fig:suite06-plateau-k2-cr}). This contrasts with Jump-$2$ at the same budget, where optima are
sampled in some runs, but the median trajectory does not converge
Figures~\ref{fig:suite09-jump-k2-cr-plateau-ref}
and~\ref{fig:suite09-jump-k2-cdp-plateau-ref}. At $k=5$, however, the distinction largely disappears:
the Plateau and Jump cumulative-regret curves are similar both in shape and in
magnitude (Figure~\ref{fig:suite06-plateau-jump-k5}). Thus, the neutral-walk mechanism is
...
\begin{figure}[H]
  ...
  \caption{Suite~11 incumbent instantaneous-regret trajectories on
...
rather than only changing final regret values; see Figure~\ref{fig:suite11-sa-cooling-ir}.
...
\begin{figure}[H]
  ...
  \end{subfigure}
  \caption{Suite~03 incumbent cumulative-regret trajectories across
...
\begin{figure}[H]
  ...
  \end{subfigure}
  \caption{Representative Suite~03 inverse runtime profile surfaces for NK
...
\begin{figure}[H]
  ...
  \end{subfigure}
  \caption{Suite~12 incumbent instantaneous-regret trajectories under
...
\begin{figure}[H]
  ...
  \end{subfigure}
  \caption{Suite~12 inverse runtime profile surfaces for higher-epistasis NK
...
In Suite~12 (overrides \ref{tab:suite12-d}), the incumbent
