...
\begin{lstlisting}[language=json,caption={[Experiment configuration schema]Schema for the configuration files to describe experiments}]
{
          ...
          "display_name": {
            ...
            "properties": {
              "by_problem": {
                ...
                "description": "Optional per-problem display name overrides",
              },
            },
            "additionalProperties": False,
            "description": "Algorithm naming overrides; defaults to top-level name",
          },
          "class": {
            "type": "string",
            "minLength": 1,
